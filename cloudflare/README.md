...
- **Jobs** — openings found by scanning your target companies' boards, plus anything added by hand. Filterable by title, company, or location; each posting links straight to the company's own listing. Every posting carries a fit verdict against your profile (Strong / Possible / Not a fit), not just a keyword match — see "Job fit assessment" below. Not-a-fit postings are hidden by default with a toggle to reveal them, and "Not for me" takes an optional reason that teaches future assessments.
